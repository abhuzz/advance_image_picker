...
/// ```dart
/// var configs = VideoPickerConfigs();
/// configs.appBarTextColor = Colors.black;
/// configs.translateFunc = (name, value) => Intl.message(value, name: name);
/// ```
class VideoPickerConfigs {
  ...
  /// configs.translateFunc = (name, value) => Intl.message(value, name: name);
  /// ```
  factory VideoPickerConfigs() {
    return _singleton;
  }
  VideoPickerConfigs._internal();

  /// Singleton object for holding the image picker configuration settings.
  static final VideoPickerConfigs _singleton = VideoPickerConfigs._internal();
  ...
  ///       int maxWidth = 1080,
  ///       int maxHeight = 1920,
  ///       VideoPickerConfigs? configs}) async => await
